...
#| fig-align: 'center'
#| fig-margin: true
#install.packages("ggwordcloud") ggf. Paket installieren
par(mar = c(0, 0, 0, 0))
library(ggwordcloud)
library(glue)
set.seed(7)
...
p<- tbl_plot %>%   
      ggplot(aes(label = wort, size = n,color=n,angle=angle)) + 
            #  geom_text_wordcloud(rm_outside = TRUE) +
             geom_text_wordcloud_area(rm_outside = TRUE, 
                                      shape = "diamond",grid_margin = 0) +
             scale_size_area(max_size = 15)+ theme_minimal() 
p
fig_name <- glue("wordcloud_airbnbZH.svg")
ggsave(xfun::from_root("figs","PVA1",fig_name),
...
#| out-width: '100%'
#| fig-align: 'center'
knitr::include_graphics(xfun::from_root('figs','PVA1','wordcloud_airbnbZH.svg'))
```
]
...
## Beispiel Jane Austen Romane

```{r}
#| echo: false
knitr::include_url('https://www.tidytextmining.com/ngrams#analyzing-bigrams',height = '450px')
```
...
tidy_wort %>%
  ...
  mutate(sentiment = positive - negative) -> tbl_sentZH
```
...
.blockquote[Beispiel: Airbnb Zürich]
...
## Balkendiagramm Sentimentanalyse
...
#| out-width: '55%'
#| fig-align: 'center'
# Identifikation der Top4 Unterkunftsarten
prop_list <- tbl_props %>%
                  slice(1:4) %>% 
                  pull(property_type)
# Filtern der Top4 Unterkunftsarten                 
tbl_plot <- tbl_sentZH %>% 
...
## Beispiel: Romane von Jane Austen

```{r}
#| echo: false
#| out-width: '55%'
#| fig-align: 'center'
knitr::include_graphics(xfun::from_root('img','PVA1','sentimentplot_austen_(Silgen_Robinson_2017).png'))
```
...
## Vergleich der Sentiment-Lexika

```{r}
#| echo: false
#| out-width: '90%'
#| fig-align: 'center'
knitr::include_graphics(xfun::from_root('img','PVA1','sentiment_compareplot_(Silge_Robinson_2017).png'))
```
...
.blockquote[Grundlagen NLP]

.blockquote[Latent Dirichlet Allocation]
...
#| fig-align: 'center'
#| out-width: '100%'
knitr::include_graphics(xfun::from_root('img','PVA1','tmwr_(Silge_Robinson_2017).png'))
...
## Kombination von tidytext- und quanteda-Funktionen

```{r}
#| echo: false
knitr::include_url('https://www.tidytextmining.com/topicmodeling#latent-dirichlet-allocation',height = '450px')
```
