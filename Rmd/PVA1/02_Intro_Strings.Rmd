...
* Leistungsstark, aber leicht zu erlernen

* Aufbauend auf stringi

* Prägnant und konsistent

* Alle Funktionen beginnen mit `str_`

* Alle Funktionen nehmen einen Vektor von Strings als erstes Argument
...
```{r}
#| echo: false
knitr::include_url('https://stringr.tidyverse.org/',height = "410px")
```
