...
```
.quelle[Bildquelle: `r Citet(bib,"barreca_assessing_2017")`.]
]
--
.pull-right[
```{r}
...
.quelle[Bildquelle: [wikipedia.org](https://en.wikipedia.org/wiki/Variogram).]
...
## Zusammenfassung Räumliche Statistik vs. Geostatistik
