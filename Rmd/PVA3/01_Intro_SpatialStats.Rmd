...
```{r}
#| echo: false
knitr::include_url(xfun::from_root("img","PVA3","Forbes_2017.png"),height="470px")
```
...
* Annahme unabhängiger Beobachtungen für statistische Tests und Regressionsanalyse 

* Verletzung der Annahme, verzerrte Schätzer und fehlerhafte p-Werte
